...
- **Crafting Planner** — pick a base + the mods you want and get several cost-ranked methods (Essence-led, Alloy-led, Transmute→Regal→Exalt, Alchemy+Chaos, Buy-Magic-base+Regal, Abyss-Mark Fracture, Desecration, Mass-slam, Remnant) each with steps, odds, and an estimated cost; **paste an in-game item** (Ctrl+C) to recreate it at the exact tiers shown; or describe a goal and get base recommendations with the cheapest method cost per base.
